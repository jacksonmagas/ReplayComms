...
void ReplayComms::onLoad()
{
	...
	//cvar2.addOnValueChanged(std::bind(&ReplayComms::YourPluginMethod, this, _1, _2));
	...
	//gameWrapper->HookEventWithCallerPost<ActorWrapper>("FUNCTIONNAME", std::bind(&ReplayComms::FUNCTION, this, _1, _2, _3));
